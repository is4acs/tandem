    ...
    <footer className="relative overflow-hidden bg-bistro text-chalk/90 mt-12 md:mt-16">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-10 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-7 md:gap-8">
          ...
          <div>
            <h3 className="font-heading text-xl text-chalk mb-4">Suivez-nous</h3>
            <div className="flex gap-4">
              <a href={RESTAURANT.social.instagram} target="_blank" rel="noopener noreferrer" className="text-chalk/60 hover:text-mountain-light transition-colors" aria-label="Instagram">
              ...
              <a href={RESTAURANT.social.facebook} target="_blank" rel="noopener noreferrer" className="text-chalk/60 hover:text-mountain-light transition-colors" aria-label="Facebook">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
