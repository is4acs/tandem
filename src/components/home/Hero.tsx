...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-bistro-dark via-bistro to-bistro-light text-chalk">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-24 lg:py-28 grid lg:grid-cols-[1.2fr_0.8fr] gap-8 md:gap-10 items-center min-h-[74vh] md:min-h-[84vh]">
        <div>
          <p className="text-[11px] md:text-sm uppercase tracking-[0.2em] md:tracking-[0.28em] text-mountain-light mb-4 md:mb-5">Bistrot traditionnel · Embrun</p>
          <h1 className="font-heading text-4xl sm:text-5xl md:text-7xl leading-[0.96] text-chalk tracking-tight">Cuisine de montagne, esprit bistrot</h1>
          <p className="mt-5 md:mt-6 text-base md:text-lg text-chalk/80 max-w-xl leading-relaxed">
          ...
          <div className="mt-7 md:mt-8 flex flex-col sm:flex-row gap-3 md:gap-4">
            <Link
              href="/carte"
              className="inline-flex items-center justify-center w-full sm:w-auto px-6 md:px-8 py-3.5 bg-accent text-white font-medium rounded-lg hover:bg-accent-dark shadow-lg shadow-accent/20"
            >
              Voir la carte
            </Link>
            <Link
              href="/evenements"
              className="inline-flex items-center justify-center w-full sm:w-auto px-6 md:px-8 py-3.5 border border-mountain-light/55 text-mountain-light font-medium rounded-lg hover:bg-mountain-light/10"
            >
        ...
        <aside className="relative bg-chalk/[0.08] border border-mountain-light/25 rounded-2xl p-5 md:p-7 backdrop-blur-none md:backdrop-blur-sm shadow-xl shadow-black/10">
          <p className="text-[11px] uppercase tracking-[0.24em] text-mountain-light">Ardoise de la montagne</p>
          <h2 className="font-heading text-2xl md:text-3xl text-chalk mt-2">L&apos;esprit Le Tandem</h2>

          <div className="mt-5 md:mt-6 space-y-4 text-chalk/85">
