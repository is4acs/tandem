...
export default function EventCard({ event }: EventCardProps) {
  return (
    <article className="bg-white rounded-2xl overflow-hidden shadow-sm border border-mountain/10 hover:shadow-md transition-shadow">
      {event.image_url && (
      ...
      <div className="p-6">
        ...
        <h3 className="font-heading text-xl text-bistro mb-2">{event.titre}</h3>
